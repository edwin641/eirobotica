    ...
    <section class="bg-gray-700 py-12 mb-12">
        <div class="container grid grid-cols-1 lg:grid-cols-2 gap-6">
            <figure>
                ...
                @else
                    <img class="h-60 w-full object-cover" src="https://images.pexels.com/photos/4443114/pexels-photo-4443114.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="">
                @endif
        ...
        <div class="order-2 lg:col-span-2 lg:order-1">
                ...
                <div class="card-body">
                    ...
                    <ul class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2">
                        ...
                        @forelse ($course->goals as $goal)
                            <li class="text-gray-700 text-base"><i class="far fa-check-circle text-blue-400 mr-2"></i>{{$goal->name}}</li>
                        @empty
                        ...
                        <div class="bg-white py-2 px-4" x-show="open">
                            <ul class="grid grid-cols-1 gap-2">
                                @foreach ($section->lessons as $lesson)
                                    <li class="text-gray-700 text-base"><i class="far fa-play-circle mr-2 text-blue-500"></i>{{$lesson->name}}</li>
                                @endforeach
                            </ul>
                        </div>
                    </article>    
                @empty
                    <article class="card py-2 px-4">
                        <div class="car-body" >
                            este curso no tiene ninguna secion asignada
                        </div>
                    </article>
                @endforelse
            </section>
            ...
            <section class="mb-8">
                ...
                <ul class="list-disc list-inside">
                    ...
                    @empty
                        <li class="text-gray-700 text-base">Este cursno no tiene nigun requerimiento</li>
                    @endforelse
                </ul>
            </section>
