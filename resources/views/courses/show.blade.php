        ...
        <div class="order-1 lg:order-2">
            <section class="card mb-4">
                <div class="card-body">
                    ...
                    @can('enrolled', $course)
                        <a class="btn btn-danger  btn-block mt-4" href="{{route('courses.status', $course)}}">Continuar con este curso</a>
                    @else
                        ...
                        @else
                            <p class="text-2xl font-bold text-gray-500 mt-3 mb-2">U$${{$course->price->value}}</p>
