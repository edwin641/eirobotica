    ...
    <div class="container grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div class="lg:col-span-2">
            ...
            <div class="flex justify-between mt-4">            
                ...
                <div class="flex items-center cursor-pointer transition-all duration-500" wire:click="completed">
                    ...
                    <p class="text-sm ml-2">Marcar  esta unidad finalizada</p>
                </div>
            ...
            <div class="card mt-2">
                <div class="card-body flex text-gray-500 font-bold ">
                    ...
                    @endif
                    @if ($this->next)
                        <a wire:click="changeLesson({{$this->next}})" class="ml-auto cursos-pointer" href="">Siguiente tema</a>    
                    @endif
