<form class="pt-2 relative mx-auto text-gray-600" autocomplete="off">
    ...
    <button type="submit" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 border border-red-700 rounded absolute right-0 top-0 mt-2">
        Buscar
    </button>
