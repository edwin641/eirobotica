<div>
                ...
                @if ($lesson->id == $item->id)
                   ...
                   <form wire:submit.prevent="update">
                       <div class="flex items-center ">
                            ...
                            <input wire:model="lesson.name" class="form-input w-full shadow-sm">
                       </div>
    ...
    <div class="mt-4" x-data="{open: false}">
        ...
        <article class="card" x-show="open">
            <div class="card-body ">
                <h1 class="text-l font-bold mb-4">Agregar nueva Leccion</h1>

                <div class="mb-4">
                    <div class="flex items-center ">
                        <label class="w-32"> Nombre:</label>
                        <input wire:model="name" class="form-input w-full shadow-sm">
                   </div>
